...
<head>
    ...
    <title>Netflix</title>
    @vite(['resources/css/styles.css', 'resources/js/app.js', 'resources/js/nav.js','resources/js/download.js'])
</head>
        ...
        @if (session('user') && session('user')['type'] == 'Admin')
            <div class="admin-container">
                ...
                <div class="admin-buttons">
                    <a href="{{ route('episodio.create', ['id' => $serie['id']]) }}" class="button-link">Añadir
                        episodio</a>
                </div>
            </div>
        @endif
                ...
                <div class="pelicula-details">
                    ...
                    <div class="pelicula-info">
                        ...
                        <div class="info-buttons">
                            ...
                            @endif
                            <a href="{{ route('serie.descargar', ['id' => $serie['id']]) }}"
                    ...
                    @foreach ($episodios as $episodio)
                        <div class="pelicula-card">
                            ...
                            <div class="pelicula-card-body">
                                <img src="{{ asset("storage/{$episodio->ArchivoImagen}") }}"
                                    alt="Imagen de la episodio">
                            </div>
                            <div class="pelicula-card-footer">
                                <a href="{{ route('episodio.show', ['id' => $serie['id'], 'id_ep' => $episodio['id']]) }}"
